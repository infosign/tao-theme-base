...
// replace taoThemeBase
namespace infosign\taoThemeBase\scripts\install;

use oat\oatbox\extension\InstallAction;
use infosign\taoThemeBase\model\theme\PlatformDefault;// provided your theme class has that name
